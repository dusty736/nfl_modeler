...
source(here("etl", "R", "step2_off_player_stats_process_functions.R"))
...
################################################################################
arrow::write_parquet(weekly_qb_stats, "data/processed/weekly_stats_qb.parquet")
arrow::write_parquet(season_qb_stats, "data/processed/season_stats_qb.parquet")
arrow::write_parquet(career_qb_stats, "data/processed/career_stats_qb.parquet")
arrow::write_parquet(weekly_rb_stats, "data/processed/weekly_stats_rb.parquet")
arrow::write_parquet(season_rb_stats, "data/processed/season_stats_rb.parquet")
arrow::write_parquet(career_rb_stats, "data/processed/career_stats_rb.parquet")
arrow::write_parquet(weekly_wr_stats, "data/processed/weekly_stats_wr.parquet")
arrow::write_parquet(season_wr_stats, "data/processed/season_stats_wr.parquet")
arrow::write_parquet(career_wr_stats, "data/processed/career_stats_wr.parquet")
